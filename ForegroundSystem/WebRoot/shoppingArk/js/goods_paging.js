	...
	function paginationNick(opt) {
		...
		function goPage(btn) {
			...
			arr.forEach(function(v) {
				i++;
				str += "<tr><td>" + v.goods_id + "</td><td>" + v.goods_name + "</td><td>" + v.goods_price + "</td><td>" + v.goods_discount + "</td><td>" + v.goods_gross + "</td><td>" + v.goods_sold + "</td><td>" + v.goods_surplus + "</td><td>" + v.goods_team + "</td><td><button class='btn" + i + "' data-toggle='modal' data-target='.modification'>修改</button>&nbsp;&nbsp;<button>删除</button></td></tr>";
			});
